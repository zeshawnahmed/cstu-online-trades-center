    ...
    return {
      ...
      'hvac-technician': {
        ...
        keyFeatures: [
          ...
          'Self Paced, Online Learning Format for Busy Professionals',
          'Connect with Local Cohort Through Fun Experiences',
          'Job Site/Field Experiences With Industry Equipment'
        ],
            ...
            >
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <span>{language === 'en' ? 'Job Site/Field Experiences With Licensed Professional' : 'Entrenamiento Práctico con Profesional Licenciado'}</span>
                </div>
              </div>

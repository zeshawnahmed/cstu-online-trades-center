  ...
  const programs = [
    {
      ...
      keyFeatures: [
        ...
        language === 'en' ? 'Job Site/Field Training Alongside Licensed Professionals' : 'Entrenamiento práctico con profesionales licenciados'
      ],
      salaryInfo: {
        median: '$103,663',
        growth: '',
    ...
    },
    {
      ...
      keyFeatures: [
        language === 'en' ? 'Job Site/Field Training Alongside Licensed Professional' : 'Entrenamiento práctico con profesional licenciado',

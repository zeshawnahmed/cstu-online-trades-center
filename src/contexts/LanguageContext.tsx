...
export const translations = {
  en: {
    ...
    costEffectiveContent: "While traditional 4-year colleges can cost $30,000+ per year, our programs provide focused, industry-relevant training at a fraction of the cost. Complete your training for just $2,499 - without sacrificing quality education.",
  ...
  es: {
    ...
    costEffectiveContent: "Mientras que las universidades tradicionales de 4 años pueden costar más de $30,000 por año, nuestros programas brindan capacitación enfocada y relevante para la industria a una fracción del costo. Complete su capacitación por solo $2,499, sin sacrificar la educación de calidad.",
    ...
    affordableEducationContent: "Nuestra matrícula de tarifa plana de $2,499 hace que la capacitación de calidad sea accesible, con opciones de ayuda financiera disponibles para aquellos que califican.",
